...
data_type = Model.FctUnit
PostgresqlDAO.getdao(x::Model.FctUnit) = return(DAO.FctUnitDAO)
get_schema_name() = "public"
get_table_name() = "fct_unit"
...
const onetomany_counterparts = Dict(
  ...
  :fctUnitStaies => (
    ...
    property = :fctUnit, # The name of the associated manytoone property

...
data_type = Model.DeletedInfectiousStatus
PostgresORM.get_orm(x::Model.DeletedInfectiousStatus) = return(ORM.DeletedInfectiousStatusORM)
get_schema_name() = "public"
get_table_name() = "deleted_infectious_status"

...
data_type = Model.AnalysisType
PostgresORM.get_orm(x::Model.AnalysisType) = return(ORM.AnalysisTypeORM)
get_schema_name() = "public"
get_table_name() = "analysis_type"
...
const onetomany_counterparts = Dict(
  ...
  :analyses => (
    ...
    property = :analysisType, # The name of the associated manytoone property

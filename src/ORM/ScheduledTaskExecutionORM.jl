...
data_type = Model.ScheduledTaskExecution
PostgresORM.get_orm(x::Model.ScheduledTaskExecution) = return(ORM.ScheduledTaskExecutionORM)
get_schema_name() = "misc"
get_table_name() = "scheduled_task_execution"

...
function WebAPI.handle_exposed_function_get(req)
...
api_routes = (api_routes..., route("/api/exposed-function/get-functions", WebAPI.handle_exposed_function_get))
...
api_routes = (api_routes..., route("/api/exposed-function/execute", WebAPI.handle_exposed_function_execute))

...
function WebAPI.handle_task_execute_pending(req)
...
api_routes = (api_routes..., route("/api/task-waiting-for-user-execution/execute-pending-tasks", WebAPI.handle_task_execute_pending))

...
module WebAPI
    ...
    include("WebAPI/__def.jl")

    module Endpoints
        include("WebAPI/Endpoints/__def.jl")
    end

    module Filters
        include("WebAPI/Filters/__def.jl")
    end
...
include("WebAPI/Endpoints/__imp.jl")
include("WebAPI/Filters/__imp.jl")

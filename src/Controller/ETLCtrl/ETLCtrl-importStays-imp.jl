function ETLCtrl.importStays(df::DataFrame,
    ...
    try
        ...
        for r in eachrow(df)
           ...
           outDateTime =passmissing(TRAQUERUtil.convertStringToZonedDateTime)(
               outDateAsStr,
               outTimeAsStr,
               _tz)

           # Get a unit
           unit = UnitCtrl.createUnitIfNotExist(unitCodeName,unitName,dbconn)
           ...
           # Retrieve the stay
           stay = StayCtrl.createStayIfNotExist(patient, unit,
                                                inDateTime,
                                                outDateTime,
                                                hospitalizationDate,
                                                dbconn)

...
@testset "Test get-stay-monitoring-scopes endpoint" begin
    ...
    try
        ...
        response_with_scope =
            WebAPI.Endpoints.handle_scope_get_stay_monitoring_scopes(req_with_scope)
        ...
        n -> open(joinpath("tmp","json", "endpoint-get-stay-monitoring-scopes.json"), "w") do f
            write(f, n)
        end

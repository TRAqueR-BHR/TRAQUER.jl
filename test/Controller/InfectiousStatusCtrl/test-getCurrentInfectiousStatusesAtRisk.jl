...
@testset "Test InfectiousStatusCtrl.getCurrentInfectiousStatusesAtRisk" begin
    ...
    try
        ...
        infectiousStatuses = InfectiousStatusCtrl.getCurrentInfectiousStatusesAtRisk(dbconn)
